...
function About() {
  return (
    <div className={montserrat.className}>
        ...
        >
            <h3 className="absolute top-0 sm:top-24 uppercase tracking-[20px] text-[#ddd4c6] text-2xl pb-2">About</h3>
            ...
            <div className="space-y-10 px-0 md:px-10 text-text-[#ddd4c6] pt-10 sm:pt-2">
